...
def get_homeworks(lesson_id):
    with requests.Session() as s:
        ...
        return s.get(
            f'https://api.100points.ru/student_live/index?email=&full_name=&hidden_last_name=&hidden_first_name=&hidden_mid_name=&vk_id=&subject_id=20&course_id=1147&module_id=3722&lesson_id={lesson_id}')
